    ...
    return (
        <div>
            <form>
                ...
                <button disabled={text.length===0} type="button" className={`btn btn-${prop.mode==="light" ? "success" : "warning"}`} onClick={handleOnClick}>Convert Text</button>
                <button disabled={text.length===0} type="button" className={`btn btn-${prop.mode==="light" ? "success" : "warning"} mx-3`} onClick={copyText}>Copy Text</button>
                <button disabled={text.length===0} type="button" className={`btn btn-${prop.mode==="light" ? "success" : "warning"}`} onClick={handleClear}>Clear Text</button>
            </form>
